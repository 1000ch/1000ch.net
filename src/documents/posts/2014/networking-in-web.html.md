...
以上のようなことがHTTP通信の基本的な動作であり、我々がWebブラウザでページを閲覧してる裏側で行われている。

普段はこれらのやりとりは当たり前のものとして気にすることはないかもしれない。しかし、複雑なWebアプリの開発現場や進化するWeb技術、パフォーマンスに取り組む中で、 **Webがどのような仕組みで動いているかは間違いなく必要な知識** だと思う。そして、Webに従事していれば職域に関わらず、覚えていて損のない知識だとも思う。

今後Webに携わる中で何かの足しになれば。