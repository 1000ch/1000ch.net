...
紹介するのは コマンドラインインターフェースとして iTerm と、テキストエディタとして Visual Studio Code である。より AI ファーストなエディタとして Cursor などもあるが、今回は割愛。
...
今から生成しようとしている SSH キーは GitHub とやりとりするものなので、デフォルトの `id_ed25519` ではなく、 `github_ed25519` としておくことをオススメする。つまり `/Users/1000ch/.ssh/github_ed25519` を入力して、実行する。
...
**Title** には、どの公開鍵を登録したかわかる名前を入れておくと良いです。例えば **Personal MacBook Pro** とかだとわかりやすいが、好みの名前で良い。
