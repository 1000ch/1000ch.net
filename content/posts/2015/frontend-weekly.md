...
![Jekyll](/img/posts/2015/frontend-weekly/logo.png)
...
メールマガジンで紹介するリソースには、ブログの記事やGitHubのライブラリが中心です。紹介するリソースの多くは英語ですが、これには理由があります。
...
こうした情報を英語から日本語してくれるメディアもありますし、有志もたくさんいます。しかし、これらだけを期待することはいくつかリスクがあります。
...
- 大量に存在するメディアの中から **信頼できる購読する情報源を選択する**
...
編集長の「日本のWebを前に進める」という大目標は掲げつつも、Frontend Weeklyはまだまだ未完成のメディアです。皆さんのフィードバックを受けながら、常にブラッシュアップしていきたいと考えています。近いうちに意見箱を用意しますので、皆さんの意見を聞かせてください。

## 最後に

最後になりますが、 **Frontend Weeklyの購読は無料** です。Webに従事するあらゆる人が、メインストリームに飛び込むきっかけになれば幸いです。
